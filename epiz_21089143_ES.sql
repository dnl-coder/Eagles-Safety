...
-- Tiempo de generación: 30-05-2020 a las 19:17:27
...
CREATE TABLE `contactanos` (
  ...
  `CONTACNOMBRE` varchar(30) NOT NULL COMMENT 'NOMBRE DE LA ENTIDAD A CONTACTAR',
  `CONTACCORREO` varchar(50) NOT NULL COMMENT 'CORREO DE LA ENTIDAD A CONTACTAR',
...
INSERT INTO `contactanos` (`CONTACCODIGO`, `CONTACNOMBRE`, `CONTACCORREO`, `CONTACMENSAJE`) VALUES
(1, 'Micha', 'micha@es.com', 'Michita'),
(2, 'Daniel Lingan', 'dalc.2506@gmail.com', 'Hola, esto es una prueba.'),
(3, 'Micha', 'no es correo', 'Michita'),
...
(16, '', '', ''),
(17, 'a', 'a', 'a'),
(18, 'QUEDI', 'QUEDI@hotmail.com', 'QUEDI');
...
(1, 'Eagles Safety E.I.R.L.', 'ES-FrontEnd/Elementos/Imagenes/abeja-corregida.png', 'ES-FrontEnd/Elementos/Imagenes/club felino peruano.png', 'esafety@es.com.pe', '5250698', '5250698', 'www.google.com', 'www.google.com', 'Los tornos 222', 'COMAS', 'LIMA', 'PERU', 1);
...
(1, '3M', 'ES-FrontEnd/Elementos/Imagenes/Marcas/marca1.jpg'),
(2, 'STEELPRO', 'ES-FrontEnd/Elementos/Imagenes/Marcas/marca2.jpg'),
(3, 'eins', 'ES-FrontEnd/Elementos/Imagenes/Marcas/marca3.png'),
(4, 'MSA', 'ES-FrontEnd/Elementos/Imagenes/Marcas/marca4.jpg'),
...
(12, 'asdf', 'asdff', 'ES-FrontEnd/Elementos/Imagenes/Slider/construction-709487_1280.jpg'),
(11, 'gaaaa', 'Angy gaaaaaaa', 'ES-FrontEnd/Elementos/Imagenes/Slider/club felino peruano.png');
...
--
ALTER TABLE `slider`
  MODIFY `SLDRCODIGO` int(11) NOT NULL AUTO_INCREMENT COMMENT 'CÓDIGO SLIDER', AUTO_INCREMENT=14;
COMMIT;
