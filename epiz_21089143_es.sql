...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-06-2020 a las 01:12:56
...
(1, 'B1', 'EXPERIENCIA, SEGURIDAD Y GARANTIA', 'Tenemos los mejores productos para garantizar que siempre regreses seguro a tu hogar.', 'ES-FrontEnd/Elementos/Imagenes/Banners/ES-Banner1.png', 1),
(2, 'B2', 'CONFIANZA EN NOSOTROS', 'Seguridad en todo momento', 'ES-FrontEnd/Elementos/Imagenes/Banners/ES-Banner1.png', 1);
...
CREATE TABLE `contactanos` (
  `CONTACCODIGO` int(11) NOT NULL COMMENT 'CÓDIGO DEL REGISTRO DE PETICIÓN DE CONTACTO',
  `CONTACCORREO` varchar(30) NOT NULL COMMENT 'NOMBRE DE LA ENTIDAD A CONTACTAR',
  `CONTACASUNTO` varchar(50) NOT NULL COMMENT 'CORREO DE LA ENTIDAD A CONTACTAR',
...
(1, 'Eagles Safety E.I.R.L.', 'ES-FrontEnd/Elementos/Imagenes/Logo.png', 'ES-FrontEnd/Elementos/Imagenes/Logo.png', 'esafety@es.com.pe', '5250698', '5551111', 'www.google.com', 'www.google.com', 'Los tornos 222', 'COMAS', 'LIMA', 'PERU', 1);
...
CREATE TABLE `marca` (
  `MARCCODIGO` int(11) NOT NULL COMMENT 'CÓDIGO DE LA MARCA',
...
CREATE TABLE `producto` (
  `PRODCODIGO` int(11) NOT NULL COMMENT 'CÓDIGO DEL PRODUCTO',
...
(34, 'UMMMMM', 'bcp.jpg', 'UMMMM', 'UMMMMM', 12, 0),
(35, 'UMMMMM', 'graña y montero.png', 'UMMMM', 'UMMMMM', 12, 0),
...
CREATE TABLE `slider` (
  `SLDRCODIGO` int(11) NOT NULL COMMENT 'CÓDIGO SLIDER',
...
(12, 'asdf', 'asdff', 'ES-FrontEnd/Elementos/Imagenes/Slider/pantalla.jpg'),
(15, 'EQUIPOS  QUE PROTEGEN  TU VIDA', 'Tenemos los mejores productos para garantizar tu cuidado', 'ES-FrontEnd/Elementos/Imagenes/Slider/construction-709487_1920.jpg'),
(16, 'Ciclo 9 :v', 'Con fe aprobamos el ciclo', 'ES-FrontEnd/Elementos/Imagenes/Slider/proteccion-puesto-de-trabajo.jpg');
...
ALTER TABLE `contactanos`
  ADD PRIMARY KEY (`CONTACCODIGO`);

--
-- Indices de la tabla `informacion`
--
ALTER TABLE `informacion`
  ADD PRIMARY KEY (`INFEMPCODIGO`),
  ADD KEY `FK_INFORMACION` (`REGCODIGO`);

--
-- Indices de la tabla `marca`
--
ALTER TABLE `marca`
  ADD PRIMARY KEY (`MARCCODIGO`);

--
-- Indices de la tabla `nosotros`
--
ALTER TABLE `nosotros`
  ADD PRIMARY KEY (`NOSTCODIGO`),
  ADD KEY `FK_NOSOTROS` (`REGCODIGO`);
...
ALTER TABLE `producto`
  ...
  ADD KEY `FK_PRODUCTO` (`CATCODIGO`);

--
-- Indices de la tabla `registrocambios`
--
ALTER TABLE `registrocambios`
  ADD PRIMARY KEY (`REGCODIGO`),
  ADD KEY `FK_REGISTROCAMBIOS` (`USUACODIGO`);

--
-- Indices de la tabla `slider`
--
ALTER TABLE `slider`
  ADD PRIMARY KEY (`SLDRCODIGO`) USING BTREE;
...
--
ALTER TABLE `categoria`
  MODIFY `CATCODIGO` int(11) NOT NULL AUTO_INCREMENT COMMENT 'CÓDIGO DE LA CATEGORÍA', AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT de la tabla `contactanos`
--
ALTER TABLE `contactanos`
  MODIFY `CONTACCODIGO` int(11) NOT NULL AUTO_INCREMENT COMMENT 'CÓDIGO DEL REGISTRO DE PETICIÓN DE CONTACTO', AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT de la tabla `marca`
--
ALTER TABLE `marca`
  MODIFY `MARCCODIGO` int(11) NOT NULL AUTO_INCREMENT COMMENT 'CÓDIGO DE LA MARCA', AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `producto`
--
ALTER TABLE `producto`
  MODIFY `PRODCODIGO` int(11) NOT NULL AUTO_INCREMENT COMMENT 'CÓDIGO DEL PRODUCTO', AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT de la tabla `slider`
--
ALTER TABLE `slider`
  MODIFY `SLDRCODIGO` int(11) NOT NULL AUTO_INCREMENT COMMENT 'CÓDIGO SLIDER', AUTO_INCREMENT=17;
COMMIT;
