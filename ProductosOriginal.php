...
<body>
    ...
    <!-- ENCABEZADO-->  
    <div class="container-fluid" style="height: 200px; background: url('ES-FrontEnd/Elementos/Imagenes/Productos/Encabezado.jpg') no-repeat center; background-size: cover;">
